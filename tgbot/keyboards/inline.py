...
class UserInline:
    ...
    def welcome_kb(lang: Literal["ru", "en"] = "ru"):
        home_button = InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
    ...
    def last_tickets_kb(lang: Literal["ru", "en"] = "ru"):
        set_coin_button = InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                               callback_data="set_coin")
        saved_tickets_button = InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                                    callback_data="saved_tickets")
        main_menu_button = InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
    ...
    def rates_list_kb(self, rates: list, step: Literal["primary", "secondary"], lang: Literal["ru", "en"] = "ru"):
        ...
        manual_button = InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
    ...
    def manual_kb(lang: Literal["ru", "en"] = "ru"):
        back_button = InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang), callback_data="set_coin")
    ...
    def value_render_kb(self,
        ...
        button_dict = dict(change_value=InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                                             callback_data=f"change_value:{step}"),
                           add_coin=InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                                         callback_data=f"add_coin:{step}"),
                           delete_ticket=InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                                              callback_data=f"delete_ticket:{ticket_timestamp}"),
                           save_ticket=InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                                            callback_data="save_ticket"),
                           save_changes=InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                                             callback_data=f"save_changes:{ticket_timestamp}"),
                           back_to_tickets=InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
                                                                callback_data="saved_tickets"),
    ...
    def back_to_render_kb(rate: str, lang: Literal["ru", "en"] = "ru"):
        button = InlineKeyboardButton(text=get_text_kb(param="home_button", lang=lang),
